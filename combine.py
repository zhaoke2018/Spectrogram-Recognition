# This file is the combination of '1' and '2'.
# '1': https://github.com/tensorflow/tensorflow/blob/master/tensorflow/examples/label_image/label_image.py
# '2': https://github.com/tkzilla/rsa_api_python_36/blob/master/rsa_api_full_example.py
# Also it's modified by Ke Zhao as part of graduation project.
# If you have any questions, please feel free to contact me @ hike1996(wechat).
# ==============================================================================
...
def main_acquire():
    ...
    global var, img, img2, photo, image
    var.set('获取成功')
    img = Image.open(entry2.get())
    img2 = img.resize((300, 200), Image.ANTIALIAS)
...
frm_m = tk.Frame(window)
frm_r = tk.Frame(window)
frm_l.pack(fill = 'both', side = 'left')
frm_m.pack(fill = 'both', side = 'left')
...
frm2 = tk.Frame(frm_l)
frm2.pack()
canvas = tk.Canvas(frm_m, height = 200, width = 300)
...
label6 = tk.Label(frm_m, text = '频谱图', bg = 'yellow', font = ('Arial', 24), width = 15, height = 2)
label6.pack()
entry3 = tk.Entry(frm3)
entry3.pack(side = 'left')
button2 = tk.Button(frm_r, text = '测试', width = 15, height = 2, command = main_test)
button2.pack()
text = tk.Text(frm_r, height = 20)
text.configure(font=("Times New Roman", 24, "bold"))
text.pack()
#GUI-end
window.mainloop()